...
public class A1Tester {
	...
	public static void testIsFactor() {
		...
		System.out.println("Testing isFactor(61,11)");
		result = A1Exercises.isFactor(11, 11);
		expected = false;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	}
	...
	public static void testNumFactors() {
		...
		System.out.println("Testing numFactors(100)");
		result = A1Exercises.numFactors(100);
		expected = 9; // There are 9 factors of 100: 1,2,4,5,10,20,25,50,100
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	}
	...
	public static void testGreatestCommonDenominator() {
		...
		result = A1Exercises.greatestCommonDenominator(20, 16);
		expected = 4;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(18, 21);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(20, 40);
		expected = 20;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		result = A1Exercises.greatestCommonDenominator(23, 47);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(5000, 15);
		expected = 5;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	}
	...
	public static void testCountMatches() {
		...
		System.out.println("Testing countMatches(arr2, 5)");
		...
		System.out.println("Testing countMatches(arr3, 0)");
